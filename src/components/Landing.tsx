  ...
  return (
    <div className="text-center bg-black flex flex-col items-center">
      <div className="container mx-auto p-4">
        <h1 className="text-4xl text-medium mt-10 mb-4">chat w/ <span className="text-orange-500">replit</span> ai podcast</h1>
        <h3 className="text-neutral-300 mb-6">
      ...
      <p className="mb-20 text-neutral-400">
